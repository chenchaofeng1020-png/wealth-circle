    ...
    <div class="auth-dialog animate-fade-in">
      ...
      <div class="terms-row">
        <label class="terms-label">
          ...
          <span>我已阅读并同意 <a href="javascript:void(0)" @click.stop="actions.showToast('已查看《财不外露社区用户协议》')">《服务协议》</a> 与 <a href="javascript:void(0)" @click.stop="actions.showToast('已查看《隐私保护指引》')">《隐私政策》</a></span>
        </label>
      </div>
