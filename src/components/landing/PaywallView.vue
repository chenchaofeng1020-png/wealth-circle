      ...
      <div class="header-inner">
        <div class="brand-block" @click="actions.resetFlow">
          ...
          <div class="brand-text">
            ...
            <span class="brand-sub">财经私享知识社区</span>
          </div>
        </div>
        ...
        <div class="header-nav-right">
          ...
          <button class="btn-logout" @click="actions.openLogoutModal">退出登录</button>
      ...
      <div class="paywall-content-box animate-fade-in">
        ...
        <div class="steps-flow-bar">
          ...
          <div class="step-node pending">
            ...
            <span class="node-label">3. 开启私享圈内容</span>
          </div>
        </div>
        ...
        <div class="welcome-notice-card">
          ...
          <div class="notice-info">
            ...
            <p class="notice-desc">
              「财不外露」为严肃实战型闭门投研社区。为了维持高质量交流生态，社区内所有<strong>动态广场、深度专栏、实盘直播与专家答疑</strong>仅对正式会员开放。请选择适合您的方案完成开通：
            </p>
          </div>
        </div>
        ...
        <div class="plan-selection-section">
          ...
          <div class="plans-grid">
            ...
            >
              <div class="plan-ribbon hot">最受欢迎 · 92% 圈友首选</div>
          ...
          <div class="privileges-grid">
            ...
            <div class="privilege-col">
              ...
              <div>
                ...
                <div class="priv-desc">每周二晚8点深度市况复盘，支持文字与语音直面圈主提问</div>
              </div>
            </div>
        ...
        <div class="checkout-footer-bar">
          ...
          <div class="action-submit-row">
            ...
            >
              ...
              <span>{{ isPaying ? '安全支付处理中...' : `立即支付 ¥${selectedTier === 'annual' ? '899' : '2,999'} 并进入社区` }}</span>
            </button>
          </div>
        </div>
      </div>
    ...
    <div v-if="showSuccessModal" class="success-backdrop">
      <div class="success-dialog animate-fade-in">
        ...
        <div class="success-benefits-summary">
          <div class="b-item">✓ 社区动态广场已全面解锁</div>
